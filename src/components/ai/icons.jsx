// Ícones compartilhados do ClimaPro IA — extraídos de AIAssistant.jsx para
// serem reutilizados por ChatHome.jsx e pelos componentes em src/components/ai/.
...
export function MicIcon({ active, className }) {
  return (
...
export function DropletIcon({ className }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.5c-3 4-6.5 8.129-6.5 11.5a6.5 6.5 0 1013 0c0-3.371-3.5-7.5-6.5-11.5z" />
    </svg>
  )
}
