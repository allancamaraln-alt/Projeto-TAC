    ...
    <div className="min-h-screen flex flex-col" style={{background: 'linear-gradient(160deg, rgb(var(--ac)) 0%, rgb(var(--ac-dk)) 100%)'}}>
      ...
      <div className="bg-white rounded-t-3xl px-6 pt-8 pb-10 shadow-2xl relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              {modo === 'login' && (
                <button
                  ...
                  className="text-xs ac-text font-semibold mt-2 float-right"
                >
                  Esqueci minha senha
                </button>
              )}
          ...
          {erro && (
            <p className={`text-sm p-3 rounded-xl clear-both ${erro.startsWith('✅') ? 'bg-green-50 text-green-700' : 'bg-red-50 text-red-600'}`}>
              {erro}
            </p>
          )}

          <button type="submit" className="btn-primary mt-2 clear-both" disabled={loading}>
